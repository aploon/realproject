...
$query = "
        ...
        WHERE personne.email_personne = '$email' AND (id_type_compte_fk_compte = 2 OR id_type_compte_fk_compte = 1)
        ";
$message = '';
...
if ($count > 0) {
    ...
    if ($data['statut_compte'] == 'Actif' || $data['statut_compte'] == 'Inactif') {
...
}else if(!is_in_database('email_personne', 'personne', $email, $db)){
