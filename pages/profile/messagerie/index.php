                                ...
                                <div class="m-b-20">
                                    <div id="chat-scroll">
                                        ...
                                        <ul class="chat-list list-unstyled m-b-0">
                                            ...
                                            <?php
                                            $query = "SELECT * FROM personnel, personne WHERE personnel.id_personne_fk_personnel = personne.id_personne";
                                ...
                                <div class="chat-about" style="float: right;">
                                    ...
                                    <div class="chat-on-projet">
                                        ...
                                        <select name="projet" id="">
                                            <?= select1('nom_projet', 'projet', 'id_projet', $db, '', "WHERE id_promoteur_fk_projet = $id_promoteur ORDER BY nom_projet DESC") ?>
                                        </select>
                                    </div>
                                </div>
                            </div>
