...
<head>
    ...
    <!-- General CSS Files -->
    <link rel="stylesheet" href="/realproject/pages/profile/assets/css/app.min.css">
    <link rel="stylesheet" href="/realproject/pages/profile/assets/modules/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="/realproject/pages/profile/assets/modules/fontawesome/css/all.min.css">

    <!-- CSS Libraries -->
    <link rel="stylesheet" href="/realproject/pages/profile/assets/modules/datatables/datatables.min.css">
    <link rel="stylesheet" href="/realproject/pages/profile/assets/modules/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="/realproject/pages/profile/assets/modules/datatables/Select-1.2.4/css/select.bootstrap4.min.css">

    <!-- Template CSS -->
    <link rel="stylesheet" href="/realproject/pages/profile/assets/css/style.css">
    <link rel="stylesheet" href="/realproject/pages/profile/assets/css/components.css">
    <!-- Custom style CSS -->
    <link rel="stylesheet" href="/realproject/pages/profile/assets/css/custom.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.5.0/font/bootstrap-icons.css">
    <link rel='shortcut icon' type='image/x-icon' href='/realproject/pages/profile/assets/img/favicon.ico' />
    <script src="/realproject/pages/profile/assets/modules/sweetalert/sweetalert.min.js"></script>
    <style>
        .chat-content {
            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown dropdown-list-toggle">
                        ...
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="/realproject/pages/profile/assets/img/img-personne/<?= $_SESSION['img_personne'] ?>" class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
                        <div class="dropdown-menu dropdown-menu-right pullDown">
                            ...
                            <a href="/realproject/pages/profile/deconnexion.php" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i> Logout
                            </a>
                        </div>
                    </li>
                </ul>
