...
if ($_GET) {
    ...
    if ($rowStatement <= 0) {
        header("Location:/realproject/pages/profile/projet/en-attente");
        exit();
    }
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="/realproject/pages/profile/projet/en-attente/">Projets en attente</a></div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card"><img class="card-img-top" src="/realproject/pages/profile/assets/img/image-vide/img1.png" alt="Placeholder">
