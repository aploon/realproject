...
if ($_GET) {
    ...
    if ($rowStatement <= 0) {
        header("Location:/realproject/pages/profile/projet/rejete");
        exit();
    }
    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="/realproject/pages/profile/projet/rejete/">Projets rejeté</a></div>
