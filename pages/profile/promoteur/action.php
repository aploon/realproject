    ...
    if(isset($_POST['btn_action'])){
        if($_POST['btn_action'] == 'view'){
            ...
            $output .= '    <table class="table">
                                <tbody>
                                    <tr>
                                        <td colspan="2" style="text-align: center;"><img class="rounded-circle" style="width: 150px;" src="/realproject/pages/profile/assets/img/img-personne/'.$result['img_personne'].'"></td>
                                    </tr> 
                                    <tr>
                                        <th>Promoteur : </th>
