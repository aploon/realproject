...
$query = "SELECT * FROM projet, promoteur, personne, secteur WHERE projet.id_promoteur_fk_projet = promoteur.id_promoteur AND promoteur.id_personne_fk_promoteur = personne.id_personne AND projet.id_secteur_fk_projet = secteur.id_secteur AND etat_projet = :etat_projet";
                ...
                <div class="row align-items-center">
                    <div class="col-xl-12">
                        <div class="section-title text-center mb-60">
                            <p><span></span>Projets en financement</p>
                        </div>
                    </div>
                </div>
                <div class="row">
