...
if (isset($_GET['Bereich'])) {
    $nom_secteur = $_GET['Bereich'];
}else{
    header("Location:/realproject");
    exit();
}

$query = "SELECT * FROM projet, promoteur, personne, secteur WHERE projet.id_promoteur_fk_projet = promoteur.id_promoteur AND promoteur.id_personne_fk_promoteur = personne.id_personne AND projet.id_secteur_fk_projet = secteur.id_secteur AND nom_secteur = :nom_secteur AND (etat_projet = 'en_cour' OR etat_projet = 'finalise')";
$statement = $db->prepare($query);
$statement->bindParam(':nom_secteur', $nom_secteur);
$statement->execute();

$result = $statement->fetchAll();
$nbrProjet = $statement->rowCount();
                        ...
                        <div class="page-title page-title-white text-center">
                            ...
                            <div class="breadcrumb-list">
                                <ul>
                                    ...
                                    <li><a href="/realproject/projets/secteurs">Secteurs</a></li>
                                    <li><?= $nom_secteur ?></li>
                                </ul>
                            </div>
                        </div>
